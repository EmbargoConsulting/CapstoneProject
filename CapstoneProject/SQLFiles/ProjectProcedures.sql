...
CREATE PROCEDURE [dbo].[insertAnimalProgram]
(@AnimalID int,
@ProgramID int,
@LastUpdatedBy varchar(50),
@LastUpdated date)
...
CREATE PROCEDURE [dbo].[insertEmployeeProgram]
@EmployeeID int,
@ProgramID int,
@LastUpdatedBy varchar(50),
@LastUpdated date
...
CREATE PROCEDURE [dbo].[insertLiveProgram]
@ProgramID int,
@Status varchar(50),
@Address varchar(50),
@City varchar(50),
...
CREATE PROCEDURE [dbo].[insertOnlineProgram]
@ProgramID int,
