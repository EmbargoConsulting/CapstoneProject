...
<asp:Content ID="Content1" ContentPlaceHolderID="ChildContent1" runat="Server">
 ...
 <div class="row">
                ...
                <!--         <div class="col-lg-2">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#contactModal" id="btnAddContact">
                        New Contact</button>
                                                    ...
                                                    <div class="col-lg-2">
                 <asp:Button ID="Button3" runat="server" CssClass="btn btn-primary"  Text="View Contacts" OnClick="btnView_Click" formnovalidate="formnovalidate"/>
                </div>
              </div>     
    ...
    <br />
            <div class="col-lg-1" style="width: 40px;"><hr /></div>
        <div class="col-lg-8">
        <asp:GridView ID="GridView2" CssClass="table table-bordered" runat="server" Visible="false" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" AutoGenerateDeleteButton="false" AutoGenerateEditButton="True" DataKeyNames="contactID" DataSourceID="contactDataSource">
                <Columns>
                    <asp:BoundField DataField="OrganizationName" HeaderText="Organization Name" SortExpression="OrganizationName" />
                ...
                <asp:SqlDataSource ID="contactDataSource" runat="server" DeleteCommand="DELETE FROM Contact WHERE ContactID = @ContactID" ConnectionString="<%$ ConnectionStrings:Project %>" SelectCommand="SELECT OrganizationName, [contactID], [name], [email], [phone] FROM [Contact] join Organization on contact.organizationID = Organization.OrganizationID" UpdateCommand="UPDATE Contact SET Name = @Name, phone = @phone, email = @email WHERE ContactID = @ContactID;">
                <DeleteParameters>
                    <asp:Parameter Name="OrganizationID" />
                </DeleteParameters>
                <UpdateParameters>
